...
parametersEffectOnMSD = true; noTrials = 0;
...
T_sim = 0.5; % days. It should be a multiple of 0.5 = operation cycle length 

% Options for parameter sweep of ASM1seq model
runNewSweeps = false; P.nSweeps = 500;P.batchSizeSweep = 50; P.nBestKparSweeps = 26;
