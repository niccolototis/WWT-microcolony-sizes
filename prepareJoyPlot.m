function joyFigs = prepareJoyPlot(P,aSt,varargin)
global spNames speciesPBE plotWhat IC_at iT
% 'variable',true If I want 10 at the top
for aSpPBE = speciesPBE
 ...
 switch IC_at
    case 'SS_computed'
        ...
        % joyPlot(data,x2_all_TRUE_micronCube(x2_ind_toPlot)',0.2,'variable',false,'FaceColor',b,'VLines',means,'StrokeColor','w');
...
%         end
 ...
 joyFigs = joyPlot(P,x_struct,data_struct,plot_type_struct,showSlices_struct,yLabels,-0.3,...
    'variable',false,'FaceColor',Facecolor_struct,'StrokeColor',StrokeColor_struct,'LineColor','black',...
    'overlapMethod',overlapMethod,'VLines',true);    
end
return
